      ...
      <div  class="page-add">
        <el-form  :model="form" ref="form" label-width="140px" class="demo-form">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="合同编号" required>
                <span>{{detail.contractNum?detail.contractNum:'无'}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="签约日期" required>
                <span>{{detail.signDate | time}}</span>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item label="客户名称" required>
            ...
            <el-button type="text" v-if="!false" @click="handleAdd('addCus')">添加</el-button>
          </el-form-item>
          <el-form-item label="项目名称" required>
            ...
            <el-button v-if="false" type="text" @click="handleAdd('addProject')">添加</el-button>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    mounted(){
      console.log(999998989)
      this.$store.commit('PUSHDIRECT', '合同详情');
      this.info.contractId=this.$route.params.id;
    this.get()
