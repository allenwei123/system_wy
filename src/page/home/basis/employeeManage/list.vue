    ...
    <div class="con-wrap">
      ...
      <el-table :data="list" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="操作" width="250">
          <template slot-scope="scope">
            <el-button type="primary" size="small" @click="openPage({name:'maintainPlan',row:scope.row})">保养计划</el-button>
      ...
      workGroupSearchAsync(queryString){
        ...
        this.searchTimer = setTimeout(() => {
          ...
          this.$xttp.post(httpUrl.searchWorkGroup,{
            ...
            if (!res['errorCode']) {
              this.workGroupOption = res['data'].records;
            }
      ...
      positionSearchAsync(queryString){
        ...
        this.searchTimer = setTimeout(() => {
          ...
          this.$xttp.post(httpUrl.searchPosition,{
            ...
            if (!res['errorCode']) {
              this.positionOption = res['data'].records;
            }
            this.selectLoading = false;
          })
        }, 500);
