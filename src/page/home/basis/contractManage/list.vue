    ...
    <div class="list-wrap">
      <div class="c-search">
        <el-form :inline="true" :model="form" class="demo-form-inline">
          ...
          <el-form-item>
            <el-select clearable v-model="form.paymentType" placeholder="付款方式" size="small">
              <el-option
          ...
          <el-form-item>
            <el-select clearable v-model="form.contractType" placeholder="保养类型" size="small">
              <el-option
          ...
          <el-form-item>
            <el-select clearable v-model="form.expire" placeholder="到期类型" size="small">
              <el-option
          ...
          <el-form-item>
            <el-input v-model="form.contractNum" clearable size="small" placeholder="合同编号"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="list" style="width: 100%" v-loading="loading">
        ...
        <el-table-column label="客户名称" :show-overflow-tooltip="true" align="center">
          <template slot-scope="scope">{{scope.row.propCompanyName}}</template>
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      find(){
        this.currentPage = 1;
        this.form.propertyCompanyId = this.propertyId ? [this.propertyId] : null;
        this.form.projectId = this.projectId ? [this.projectId] : null;
        this.get();
      },
      /**
       * @description 换页
