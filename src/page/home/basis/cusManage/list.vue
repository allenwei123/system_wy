    ...
    <div class="page-list">
      <div class="c-search">
        <el-form :inline="true" :model="form" class="demo-form-inline">
          <el-form-item>
            <el-input v-model="form.name" placeholder="客户名称" clearable size="small"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="list" style="width: 100%" v-loading="loading">
        <el-table-column label="客户名称" :show-overflow-tooltip="true" width="200" align="center">
          <template slot-scope="scope">{{ scope.row.name }}</template>
        </el-table-column>
        <el-table-column label="联系人" :show-overflow-tooltip="true" align="center" width="200">
          <template slot-scope="scope">{{ scope.row.contactPersonName  }}</template>
        </el-table-column>

        <el-table-column label="联系方式" :show-overflow-tooltip="true" align="center" width="200">
        ...
        <el-table-column label="相互关联" :show-overflow-tooltip="true" align="center" width="100">
          <template slot-scope="scope">
            <span v-if="scope.row.bindState === 0">未绑定</span>
            <span v-if="scope.row.bindState === 1">申请绑定中</span>
            <span v-if="scope.row.bindState === 2">已绑定</span>
          </template>
        </el-table-column>
