				...
				<el-tabs v-model="activeName" @tab-click="handleClick">
				   ...
				   <el-tab-pane label="电梯信息" name="fourth">
						<ul class="liftmasage">
							...
							<li>
								<span>电梯类型:</span>
								<p>{{listData.typeName==1?'直梯':listData.typeName==2?'扶梯':listData.typeName==3?'自动人行道':''}}</p>
							</li>
							<li>
								<span>电梯名称:</span>
								<p>{{listData.name}}</p>
							...
							<li>
								<span>电梯用途:</span>
								<p>{{listData.useTypeName==1?'别墅梯':listData.useTypeName==2?'客梯':listData.useTypeName==3?'货梯':listData.useTypeName==4?'车库梯':listData.useTypeName==5?'医用梯':''}}</p>
							</li>
							<li>
								<span>注册代吗:</span>
							...
							<li>
								<span>开门方式:</span>
								<p>{{listData.openTypeName==1?'左开':listData.openTypeName==2?'中开':listData.openTypeName==3?'右开':listData.openTypeName==4?'双开':" "}}</p>
							</li>
							<li>
								<span>品牌:</span>
